...
#Region "Btn"
    ...
    Private Sub btnLayBN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLayBN.Click
        ...
        Dim _sqltemp As String = "select b2.mabn,b1.makcb,b2.tenbn hoten,b2.dangdt,b1.ngaytt from ttthanhtoanravien@duoibang b1 join dangky@duoibang b2 on b1.makcb = b2.makcb and Exists(select top 1 1 from dmdoituongsd where madt = b2.madt and matldt = 1) where datt=1"
