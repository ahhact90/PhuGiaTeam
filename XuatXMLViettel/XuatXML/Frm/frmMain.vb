...
#Region "Form"
    ...
    Private Sub frmMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If IO.File.Exists(My.Application.Info.DirectoryPath & "\bg.jpg") Then
            Me.BackgroundImage = New Bitmap(My.Application.Info.DirectoryPath & "\bg.jpg")
        Else
            Me.BackgroundImage = My.Resources.bg_Img
        End If
