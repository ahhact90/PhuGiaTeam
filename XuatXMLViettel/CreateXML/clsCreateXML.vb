	...
	(
		case 
			...
			then
                ...
                Stuff((select ';'+ mabenh from chandoankhambenh{1} where idkhambenh = (select top 1 idkhambenh from khambenh{1} where makcb = @makcb order by ngaykham desc) and benhchinh = 1 For Xml Path('')),1,1,'')
		end
	)
	ma_benh,
	isnull((
...
(case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') = 3 then convert(decimal(18,2),b4.tienbntt - b4.tongbn100) else 0 end) t_bntt,
(case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') = 3 then 0 else convert(decimal(18,2),b4.tienbntt - b4.tongbn100) end) t_bncct,
...
(case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') &lt;&gt; 3 then convert(decimal(18,2),b3.tienbn) else 0 end) t_bncct,
...
set @makcb ='{0}'
    ...
    ,'' t_trantt,(case when b3.pthuong is not null then b3.pthuong  when b3.makhoan in (select makhoan from dmkhoan where maloaik=1) then 100 else {6} end) muc_huong,0 t_nguonkhac,(case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') = 3 then convert(decimal(18,2),b3.tienbn) else 0 end) t_bntt,

convert(decimal(18,2),b3.tienbh) t_bhtt,

(case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') = 3 then 0 else convert(decimal(18,2),b3.tienbn) end) t_bncct,
0 t_ngoaids,
...
(case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') = 3 then convert(decimal(18,2),b3.tienbn) else 0 end) + (case when isnull(b3.tyle,100) = 100 then 0 else convert(decimal(18,2),convert(decimal(18,2),(b3.soluong-isnull((select Sum(soluong) from tttralaihhchitiet_thuoc{1} where idttchitiet = b3.idttchitiet),0)) * convert(decimal(18,2),isnull(b3.giabhytcn,b3.dongia))) * convert(decimal(18,2),(100 - b3.tyle)) / convert(decimal(18,2),100)) end)
 t_bntt,
convert(decimal(18,2),b3.tienbh) t_bhtt,
(case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') = 3 then 0 else convert(decimal(18,2),b3.tienbn) end) t_bncct,0 t_ngoaids,
...
set @makcb ='{0}'
    ...
    0 t_nguonkhac,
    (case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') = 3 then convert(decimal(18,2),b3.tienbn) else 0 end) t_bntt,
    convert(decimal(18,2),b3.tienbh) t_bhtt,
    (case when isnull((case when isnull(b1.capcuu,0)=1 then 2 else (case when Exists(select top 1 1 from dmtuyendksd where matdk=b1.matdk and matltdk=1) then 1 else 3 end) end ),'') = 3 then 0 else convert(decimal(18,2),b3.tienbn) end) t_bncct,
    0 t_ngoaids,
